...
\if0\blind
\thanks{%
	For helpful comments we thank Larry Bartels, Devin Caughey, Shira Mitchell, Jacob Montgomery, John Sides, Matt Tyler, and panelists at the 2023 APSA panel on Developments in Survey Methods. An \texttt{R} package implementing methods proposed in this paper is available for download at \url{http://github.com/wpmarble/calibratedMRP} and key functionality is demonstrated in Appendix \ref{apx:software}.
	}
\fi
}
...
~\\~\medskip~\\%
Conditionally accepted, \textit{Political Analysis}
}
...
\input{sections/MichiganValidation}
